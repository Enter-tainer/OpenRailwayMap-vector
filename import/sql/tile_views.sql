...
RETURN (
  ...
  FROM (
    ...
    SELECT
      ...
      way_length::double precision as way_length,
      feature,
      state,
      usage,
      service,
      ...
      radio,
      line_routes,
      route_count::integer as route_count,
      wikidata,
      wikimedia_commons,
    ...
    FROM (
      SELECT
        ...
        (select count(*)::integer from route_line rl join routes r on rl.route_id = r.osm_id where rl.line_id = l.osm_id) as route_count,
        wikidata,
        wikimedia_commons,
        wikimedia_commons_file,
        image,
...
CREATE OR REPLACE VIEW railway_text_stations AS
  SELECT
    ...
    any_value(count)::integer as count,
